...
def count_bags(bag1, contains_bag):
    if len(contains_bag.items()) == 0:
        return 0
    else:
        count = 0
        for bag2 in contains_bag[bag1]:
            count += contains_bag[bag1][bag2]
            count += contains_bag[bag1][bag2] * count_bags(bag2, contains_bag)
...
with open("input.txt") as f:
    ...
    print(count_bags("shiny gold bag", contains_bag))